(function(){
	...
	Chart.Type.extend({
		...
		initialize:  function(data){
			...
			this.ScaleClass = Chart.Scale.extend({
				...
				calculateBarWidth : function(datasetCount){
                    ...
                    //Set barWidth to a default 20px <Louis>
                    return 20;
				},
				...
				if (this.datasets && this.datasets.length > 1) {
					...
					medianPosition = (function(index) {
						...
						helpers.each(Elements, function(element) {
							...
							total.value = +total.value + +element.value;
					...
					new Chart.MultiTooltip({
						...
						title: (!ChartElements[0].label.match(/\d+/g)) ? ('Department ' + ChartElements[0].label) :
                               (ChartElements[0].label.match(/-/g)) ? ('Section ' + ChartElements[0].label.split('-')[1]) :
                               ('Course ' + ChartElements[0].label),
						chart: this.chart,
						ctx: this.chart.ctx,
		...
		draw : function(ease){
            ...
            //Draw a white background on the canvas <Louis>
